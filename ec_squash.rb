...
class Qa
  attr_accessor :q, :a, :order, :start_time, :end_time
...
@csv = [['ticker','date','reason','ca','first_nm','surname','affln','firm','jobt','no_words','no_questions','no_words_having_questions','call_date','no_people_respond','order','start_time','end_time']]

qas.each do |qa|
  @csv << qa.q.to_a + [qa.a.length,qa.order,qa.start_time.to_str,qa.end_time.to_str]
